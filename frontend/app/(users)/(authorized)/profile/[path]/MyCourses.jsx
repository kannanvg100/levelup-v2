...
import { Card, CardBody, CardFooter, Image, Link, Progress, Spacer, Tooltip, useDisclosure } from '@nextui-org/react'
										...
										<div>
											{item?.rating ? (
												<Tooltip
													...
													<div className="flex items-center border-2 px-1 cursor-pointer">
