...
const columns = [
	...
	{ name: 'CATEGORY', uid: 'category', width: '100px' },
	{ name: 'AUTHOR', uid: 'teacher', width: '100px' },
...
const INITIAL_VISIBLE_COLUMNS = ['thumbnail', 'title', 'teacher', 'category', 'price', 'createdAt', 'status', 'actions']
					...
					<div className="relative flex justify-end items-center gap-2">
						<Dropdown radius='none'>
							...
							<DropdownMenu
								...
								<DropdownItem
									onClick={() => {
										window.open(`/courses/${course?.slug}/${course?._id}`)
									}}>
									View
								</DropdownItem>
								<DropdownItem
