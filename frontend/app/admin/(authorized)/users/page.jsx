...
const columns = [
	...
	{ name: 'METHOD', uid: 'method', width: '100px' },
...
const INITIAL_VISIBLE_COLUMNS = ['profileImage', 'name', 'method', 'email', 'status', 'actions']
...
export default function App() {
	...
	const [statusFilter, setStatusFilter] = React.useState(['active', 'blocked', 'pending'])
